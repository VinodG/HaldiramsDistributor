...
package com.winit.common.httpimage;
...
public class FileSystemPersistence implements BitmapCache {
    ...
    public Bitmap loadData(String key) {
        ...
        File file = new File( new File(mBaseDir), key) ;
        return BitmapUtil.decodeFile(file.getAbsolutePath(), HttpImageManager.DECODING_MAX_PIXELS_LARGE);
    }
    ...
    public void storeData(String key, Object data) {
        ...
        try {
            ...
            if(DEBUG) LogUtils.errorLog(TAG, "error storing bitmap");
        }
        finally {
