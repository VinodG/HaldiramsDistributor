...
import com.winit.haldiram.ui.activities.BaseActivity;
...
public class UnCaughtException implements UncaughtExceptionHandler {
    private static final String RECIPIENT = "girishv@winitsoftware.com";
    ...
    public void sendErrorMail(final StringBuilder errorContent) {
        ...
        new Thread() {
            ...
            public void run() {
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                Intent sendIntent = new Intent(
                                        Intent.ACTION_SEND);
                                String subject = "WINIT Napco Log. Napco";
                ...
                builder.setMessage("Sorry for inconvenience. Napco app stopped working.");
