...
/**
 * Created by Awaneesh on 5/17/2017.
 */
...
public class LineGraphActivity extends BaseActivity{
    ...
    protected void initialize() {
        inflater.inflate(R.layout.line_graph, flBody, true);
...
//drawing bar chart
        mChart = ChartFactory.getLineChartView(LineGraphActivity.this, dataset, multiRenderer);
