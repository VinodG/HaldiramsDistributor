...
public class OutOfStockParser extends BaseHandler{
    ...
    public void startElement(String uri, String localName, String qName,Attributes attributes) throws SAXException
    {
        ...
        if(localName.equalsIgnoreCase("Distributor_OutOfStockDcos"))
        {
            vecStocks = new Vector<StockDO>();
        }
        else if(localName.equalsIgnoreCase("Distributor_OutOfStockDco"))
        {
            stockDO = new StockDO();
        }
    }
    ...
    public void endElement(String uri, String localName, String qName)throws SAXException
    {
        ...
        else if(localName.equalsIgnoreCase("Distributor_OutOfStockDcos"))
        {
    ...
    {
        new StocksDA().insertOOS(vecStocks);
    }
